...
if(NOT "/workspace/catkin_ws/src/ndt_localizer/include " STREQUAL " ")
  set(ndt_localizer_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/catkin_ws/src/ndt_localizer/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ndt_localizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/catkin_ws/src/ndt_localizer/${idir}'.  ${_report}")
    endif()
