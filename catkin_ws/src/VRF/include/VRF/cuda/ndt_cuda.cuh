#ifndef VRF_NDT_CUDA_CUH
#define VRF_NDT_CUDA_CUH
...
#include <VRF/ndt/ndt_settings.hpp>
...
public:
  ...
  void set_distance_mode(VRF::NDTDistanceMode mode);
  void set_resolution(double resolution);
  void set_neighbor_search_method(VRF::NeighborSearchMethod method, double radius);
...
public:
  VRF::NDTDistanceMode distance_mode;
  double resolution;
