...
[![Build](https://github.com/SMRT-AIST/VRF/actions/workflows/build.yml/badge.svg)](https://github.com/SMRT-AIST/VRF/actions/workflows/build.yml) on melodic & noetic
...
```bash
cd ~/catkin_ws/src
git clone https://github.com/SMRT-AIST/VRF --recursive
...
```bash
roscd VRF/data
rosrun VRF gicp_align 251370668.pcd 251371071.pcd
```
...
See [src/align.cpp](https://github.com/SMRT-AIST/VRF/blob/master/src/align.cpp) for the detailed usage.
...
rosrun VRF gicp_kitti /your/kitti/path/sequences/00/velodyne
```
...
- [VRF](https://github.com/SMRT-AIST/VRF)
