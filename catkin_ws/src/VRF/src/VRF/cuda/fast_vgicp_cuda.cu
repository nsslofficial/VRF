#include <VRF/cuda/fast_vgicp_cuda.cuh>

#include <thrust/device_new.h>
#include <thrust/host_vector.h>
#include <thrust/device_vector.h>

#include <VRF/cuda/brute_force_knn.cuh>
#include <VRF/cuda/covariance_estimation.cuh>
#include <VRF/cuda/covariance_regularization.cuh>
#include <VRF/cuda/gaussian_voxelmap.cuh>
#include <VRF/cuda/compute_mahalanobis.cuh>
#include <VRF/cuda/compute_derivatives.cuh>
...
void FastVGICPCudaCore::set_neighbor_search_method(VRF::NeighborSearchMethod method, double radius) {
