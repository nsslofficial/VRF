...
VRF::CompressDiff compressed_diff;
...
void Publish_String(ros::Publisher *pc_pub, int frame_number,VRF::CompressDiff data);
...
void Advertise_String_Topic(ros::NodeHandle *nh_ptr, std::string topic, ros::Publisher *pub_ptr, int queue_size) {
  ...
  // Advertise topics
  *pub_ptr = nh_ptr->advertise<VRF::CompressDiff>(topic, queue_size);
