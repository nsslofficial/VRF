...
dataset_path_base = "/dataset/usc_data_accuracy/D"
Autopass_path = "vrf/"
...
accuracy_df = pd.concat([accuracy_dataset_1, accuracy_dataset_2, accuracy_dataset_3, accuracy_dataset_4,  accuracy_dataset_5], ignore_index=True)

accuracy_df = accuracy_df[accuracy_df['distance'] <distance_threshold]
